// from https://github.com/spite/THREE.CubemapToEquirectangular/blob/master/src/CubemapToEquirectangular.js
...
`;
    ...
    CubemapToEquirectangular.prototype.getCubeCamera = function (size) {
        ...
        var cubeRenderTarget = new THREE.WebGLRenderTargetCube(cubeMapSize, options);
    ...
    CubemapToEquirectangular.prototype.readPixelsFromScreen = function (download) {
        var gl = this.renderer.getContext();
    ...
    CubemapToEquirectangular.prototype.readPixelsFromRenderTarget = function (download) {
        var pixels = new Uint8Array(4 * this.width * this.height);
    ...
    CubemapToEquirectangular.prototype.download = function (imageData) {
        ...
        this.canvas.toBlob(function (blob) {
            ...
            var fileName = 'ffly-' + document.title + '-' + Date.now() + '.png';
    ...
    CubemapToEquirectangular.prototype.update = function (camera, scene) {
        ...
        this.convert(this.cubeCamera, false);
    }
...
// ; (function () {
//     function CubemapToEquirectangular2(renderer, provideCubeCamera) {
...
//     CubemapToEquirectangular2.prototype.setSize = function (width, height) {
...
//     CubemapToEquirectangular2.prototype.getCubeCamera = function (size) {
...
//     CubemapToEquirectangular2.prototype.attachCubeCamera = function (camera) {
...
//     CubemapToEquirectangular2.prototype.convert = function (cubeCamera, download) {
...
//     CubemapToEquirectangular2.prototype.download = function (imageData) {
...
//     CubemapToEquirectangular2.prototype.update = function (camera, scene) {
...
//     if (typeof exports !== 'undefined') {
//         if (typeof module !== 'undefined' && module.exports) {
//             exports = module.exports = CubemapToEquirectangular2
//         }
//         exports.CubemapToEquirectangular2 = CubemapToEquirectangular2
//     }
//     else {
//         root.CubemapToEquirectangular2 = CubemapToEquirectangular2
//     }
